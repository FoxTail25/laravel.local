<x-layout>
    ...
    <x-task.head :data="['fundamentals_task1', 'Задачи:']" />
    <x-task.body2 href='fundamentals-task' :tasks="[
        1 => [
            'text' =>
    ...
    <x-task.head :data="['fundamentals_task2', 'Задача:']" />
    <x-task.body2 href='fundamentals-task' :tasks="[
        5 => [
            'text' =>
                'Пусть в действии дана переменная, содержащая CSS класс. Передайте эту переменную в представление и для какого-нибудь тега значением атрибута class укажите нашу переменную',
    ...
    <x-task.head :data="['fundamentals_task3', 'Задачи:']" />
    <x-task.body2 href='fundamentals-task' :tasks="[
        6 => [
            'text' =>
    ...
    <x-task.head :data="['fundamentals_task4', 'Задачи:']" />
    <x-task.body2 href='fundamentals-task' :tasks="[
        8 => [
            'text' =>
    ...
    <x-task.head :data="['fundamentals_task5', 'Задачa:']" />
    <x-task.body2 href='fundamentals-task' :tasks="[
        11 => [
            'text' =>
                'Пусть в переменной хранится строка с тегами, например: $str = <b>text</b> Выведите эту строку на экран так, чтобы теги выполнили свое действие (то есть чтобы в данном случае текст стал жирным).',
        ],
    ]" />
    <br />
    <br />
