...
&lt;?php
    ...
    <h3>
        Количество записей в выборке через DB в Laravel
    </h3>
    ...
    <h3>
        Сдвиг при выборке через DB в Laravel
    </h3>
    ...
    <a href="/DB/records-task/6">
        Получите первых 3 юзера.
    </a>
    <br />
    <a href="/DB/records-task/7">
        Получите первых 3 юзера, начиная с 4го
    </a>
