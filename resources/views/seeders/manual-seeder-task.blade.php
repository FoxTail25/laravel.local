<x-layout>
    ...
    class DatabaseSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task1">Назад к задачам</a>
    @elseif ($id == 2)
        <x-page.tasks.header :text="$text" />
        <pre>&lt;?php
    ...
    class DatabaseSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task2">Назад к задачам</a>
    @elseif ($id == 3)
        <x-page.tasks.header :text="$text" />
        <pre>&lt;?php
    ...
    class UserSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task3">Назад к задачам</a>
    @elseif ($id == 4)
        <x-page.tasks.header :text="$text" />
    ...
    class UserSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task4">Назад к задачам</a>
    @elseif ($id == 5)
        <x-page.tasks.header :text="$text" />
    ...
    class DatabaseSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task5">Назад к задачам</a>
    @elseif ($id == 8)
        <x-page.tasks.header :text="$text" />
    ...
    */ Но на удивление, в laravel 12 всё идеально отработало.
    ...
    class DatabaseSeeder extends Seeder
    {
        ...
        */
        ...
        <br />
        <br />
        <a href="{{ route('manual-seeder') }}#seeder_task6">Назад к задачам</a>
    @endif
