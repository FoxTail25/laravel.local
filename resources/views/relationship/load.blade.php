...
use Illuminate\Database\Eloquent\Model;
    ...
    <x-page.content.task.body href='relationship-load-task' :tasks="[
        1 => [
    ...
    <x-page.content.task.body href='relationship-load-task' :tasks="[
        2 => [
            'text' => 'Придумайте аналогичную задачу со своими таблицами и реализуйте ее.',
        ],
    ]" />
    <br />
    <br />
    ...
    В предыдущих уроках были рассмотрены основные виды связей моделей и операций с этими связями. Намеренно была
    исключена часть теории, чтобы не перегружать вас лишней информацией. Подробное описание работы связывания можно
    найти в <a
